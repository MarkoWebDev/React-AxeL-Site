      ...
      <div className="grid grid-cols-2 justify-items-center items-center">
        <div className="w-4/5 pl-24">
          ...
          <h1
            className={
              theme === "light"
                ? "text-5xl font-russonOne font-medium no-underline align-middle tracking-wide normal-case leading-normal text-dark"
                : "text-5xl font-russonOne font-medium no-underline align-middle tracking-wide normal-case leading-normal text-white"
            }
          >
            AxeL Brand new{" "}
            <span
              className={
                theme === "light"
                  ? "text-dark text-6xl font-petitFormal font-bold"
                  : "text-white text-6xl font-petitFormal font-bold"
              }
            >
              Furniture
            </span>{" "}
